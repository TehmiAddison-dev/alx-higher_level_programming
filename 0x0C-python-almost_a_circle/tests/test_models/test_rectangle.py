...
given"
    ...
    def test_instantiation(self):
        ...
        d = {'_Rectangle__height': 20, '_Rectangle__width': 10,
             '_Rectangle__x': 0, '_Rectangle__y': 0, 'id': 100}
    ...
    def test_instantiation_positional(self):
        ...
        d = {'_Rectangle__height': 10, '_Rectangle__width': 5,
             '_Rectangle__x': 15, '_Rectangle__y': 20, 'id': 111}
        self.assertEqual(r.__dict__, d)
    ...
    def test_properties(self):
        ...
        d = {'_Rectangle__height': 101, '_Rectangle__width': 100,
             '_Rectangle__x': 102, '_Rectangle__y': 103, 'id': 112}
        self.assertEqual(r.__dict__, d)
...
"""
    ...
    def test_str(self):
        ...
        r = Rectangle(5, 2)
        s = '[Rectangle] (115) 0/0 - 5/2'
        self.assertEqual(str(r), s)
        r = Rectangle(1, 1, 1)
        s = '[Rectangle] (116) 1/0 - 1/1'
        self.assertEqual(str(r), s)
        r = Rectangle(3, 4, 5, 6)
        s = '[Rectangle] (117) 5/6 - 3/4'
        self.assertEqual(str(r), s)
